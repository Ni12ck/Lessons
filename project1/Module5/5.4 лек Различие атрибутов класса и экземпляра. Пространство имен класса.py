...
# Можно переписать атрибут класса в атрибут конкретного экземпляра
# Andrey.AP = False - запись в консоли
# Andrey.__dict__ - запись в консоли
