...
print('Пункт 4')
# Вызов метода __radd__(self, value) - увеличил количество этажей House_1 на 10 (теперь должно быть 20 этажей)
House_2 = 10 + House_2
print(House_2)

# Вызов метода __iadd__(self, value) - увеличил количество этажей House_1 на 10 (теперь должно быть 20 этажей)
House_1 += 10
print(House_1)
